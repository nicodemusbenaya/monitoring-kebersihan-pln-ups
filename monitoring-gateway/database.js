...
const TABLES = Object.freeze({
  ...
  ACTIVITIES: { table: 'activities', key: 'ActivityId', columns: ['ActivityId', 'RoomTypeId', 'Name', 'StandardCategory', 'StandardText', 'QualityApplicable', 'QualityPositive', 'QualityNegative', 'FunctionApplicable', 'FunctionPositive', 'FunctionNegative', 'ExportRow', 'Active', 'SortOrder', 'CreatedAt', 'UpdatedAt'] },
  ...
  INSPECTION_PHOTOS: { table: 'inspection_photos', key: 'PhotoId', columns: ['PhotoId', 'InspectionId', 'FileId', 'FileName', 'CapturedAt', 'SortOrder'] },
  EVALUATION_ASPECTS: { table: 'evaluation_aspects', key: 'AspectId', columns: ['AspectId', 'RoomTypeId', 'Code', 'Label', 'Active', 'SortOrder', 'CreatedAt', 'UpdatedAt'] },
  EVALUATIONS: { table: 'evaluations', key: 'EvaluationId', columns: ['EvaluationId', 'RoomId', 'RoomTypeId', 'Rating', 'RatingLabel', 'AspectCodes', 'Comment', 'DateKey', 'WeekStart', 'MonthKey', 'SubmittedAt', 'Source', 'UserAgent'] },
